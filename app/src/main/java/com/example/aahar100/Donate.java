...
public class Donate extends FragmentActivity {
    ...
    private MapView mMap; // ✅ Changed from GoogleMap
    ...
    private void FoodMapDataPushFunction(String key) {
        GeoPoint userLocation = new GeoPoint(latitude, longitude); // ✅ Changed to GeoPoint
        ...
        ReadWriteLocation readWriteLocation = new ReadWriteLocation(latitude, longitude, name, number, val);
    ...
    private void MapWorkingRandomKeyWithUid(String key) {
        ...
        ref.child(firebaseUser.getUid()).setValue(readWriteMapDonationAndUserId)
    ...
    private void WorkingRandomKey() {
        ...
        uniqueIdListRef.orderByValue().equalTo(randomKey)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            MapWorkingRandomKeyWithUid(randomKey);
                        }
                    }
        ...
        FirebaseDatabase.getInstance().getReference().child("History")
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Donate.this, "error while pushing data into History node",
